...
test""",
    ...
    def test_django_variables(self):
        ...
        self._test("#{greeting} #{name}, how are you #{date}?", "{{ greeting }} {{ name }}, how are you {{ date }}?")
        ...
        self._test("Hi ={name}, how are you?", "Hi {{ name }}, how are you?", options={"django_inline_style": True})
        ...
        # they can be escaped
        self._test(
            "%a{'b': '\\\\#{greeting} test', title: \"It can't be removed\"} blah",
    ...
    def test_doctypes(self):
        ...
        self._test(
            "!!! strict",
            '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">',  # noqa
            options={"format": "xhtml"},
        )
        self._test(
            "!!! frameset",
            '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Frameset//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-frameset.dtd">',  # noqa
            options={"format": "xhtml"},
        )
        self._test(
            "!!! mobile",
            '<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.2//EN" "http://www.openmobilealliance.org/tech/DTD/xhtml-mobile12.dtd">',  # noqa
            options={"format": "xhtml"},
        )
        self._test(
            "!!! basic",
            '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML Basic 1.1//EN" "http://www.w3.org/TR/xhtml-basic/xhtml-basic11.dtd">',  # noqa
            options={"format": "xhtml"},
        )
        self._test(
            "!!! transitional",
        ...
        self._test(
            "!!! strict",
            '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">',  # noqa
            options={"format": "html4"},
        )
        self._test(
            "!!! frameset",
            '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Frameset//EN" "http://www.w3.org/TR/html4/frameset.dtd">',  # noqa
            options={"format": "html4"},
        )
        self._test(
            "!!! transitional",
        ...
        self._test("!!! XML iso-8589", "<?xml version='1.0' encoding='iso-8589' ?>", options={"format": "xhtml"})

    def test_attr_wrapper(self):
        self._test(
            "%p{ :strange => 'attrs'}", "<p strange=*attrs*></p>", options={"attr_wrapper": "*", "escape_attrs": True}
        )
        self._test(
            "%p{ :escaped => 'quo\"te'}",
            '<p escaped="quo&quot;te"></p>',
    ...
    def test_utf8(self):
        self._test(
            "%a{'href':'', 'title':'링크(Korean)'} Some Link", "<a href='' title='\ub9c1\ud06c(Korean)'>Some Link</a>"
        )
