...
arg_parser.add_argument(
    "-i", "--input-extension", metavar="EXT", help="The file extensions to look for.", type=str, nargs="+"
)
arg_parser.add_argument(
    "-ext",
    "--extension",
    metavar="EXT",
    default=Options.OUTPUT_EXT,
    help="The output file extension. Default is .html",
    type=str,
)
arg_parser.add_argument(
    "-r",
    "--refresh",
    metavar="S",
    default=Options.CHECK_INTERVAL,
    type=int,
...
arg_parser.add_argument(
    "--tag", type=str, nargs=1, action=StoreNameValueTagPair, help="Add self closing tag. eg. --tag macro:endmacro"
)
arg_parser.add_argument(
    "--attr-wrapper",
    dest="attr_wrapper",
...
arg_parser.add_argument(
    "--jinja", default=False, action="store_true", help="Makes the necessary changes to be used with Jinja2."
)
arg_parser.add_argument(
    "--once",
    default=False,
